  ...
  grunt.initConfig({
    ...
    combine: {
      single: {
        ...
        output: "./paper.alterdot.network.html",
        tokens: [
    ...
    lineending: {               // Task
      dist: {                   // Target
        ...
        files: {                // Files to process
          './paper.alterdot.network.html': ['./paper.alterdot.network.html']
        }
      }
    },
    ...
    assetenc: {
      ...
      rootAlias: 'images',
      dst: './paper.alterdot.network.html',
      template: './paper.alterdot.network.html',
    },
